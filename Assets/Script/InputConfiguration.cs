...
//     version 1.11.2
//     from Assets/Script/InputConfiguration.inputactions
//
...
public partial class @InputConfiguration: IInputActionCollection2, IDisposable
{
    ...
    ~@InputConfiguration()
    {
        UnityEngine.Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, InputConfiguration.Gameplay.Disable() has not been called.");
    }
